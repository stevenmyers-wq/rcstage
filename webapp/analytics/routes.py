...
def analytics_authorize():
    """Step 1: OAuth Redirect with EditExtensions scope."""
    ...
    # CRITICAL: We must ask for EditExtensions here
...
def analytics_callback():
    """Step 2: Swap Employee token for Customer context."""
...
def execute_delete():
    ...
    tester = RCOperabilityTest(account_id=target_id, token=token)
