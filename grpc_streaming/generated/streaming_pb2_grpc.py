...
from generated import streaming_pb2 as streaming__pb2
...
class StreamingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Stream = channel.stream_unary(
                ...
                request_serializer=streaming__pb2.StreamEvent.SerializeToString,
...
def add_StreamingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Stream': grpc.stream_unary_rpc_method_handler(
                    servicer.Stream,
                    request_deserializer=streaming__pb2.StreamEvent.FromString,
...
class Streaming(object):
    ...
    def Stream(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/ringcentral.ringcx.streaming.v1beta2.Streaming/Stream',
            streaming__pb2.StreamEvent.SerializeToString,
